...
<meta charset="utf-8" />
<%--
<link rel="apple-touch-icon" sizes="76x76" href="<minuet:contextWithResources/>/img/apple-icon.png" />
<link rel="icon" type="image/png" href="<minuet:contextWithResources/>/img/favicon.png" />
--%>
